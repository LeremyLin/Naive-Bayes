...
def NB():
   ...
   for i in range(num_of_feature):
      p_prior[i][0][0] = (vector[i][0][0])/(vector[i][0][0] +
                                            vector[i][1][0])
      p_prior[i][1][0] = (vector[i][1][0])/(vector[i][0][0] +
                                            vector[i][1][0])
      p_prior[i][0][1] = (vector[i][0][1])/(vector[i][0][1] +
                                            vector[i][1][1])
      p_prior[i][1][1] = (vector[i][1][1])/(vector[i][0][1] +
                                            vector[i][1][1])
   ...
   # Open the test file
   fileTest = open('heart-test.txt','r',
                   encoding="utf8").read().splitlines()
